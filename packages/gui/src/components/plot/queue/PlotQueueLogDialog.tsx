import { useGetPlotQueueQuery, useThrottleQuery } from '@bpx-chain/api-react';
import { Button, Flex, Log } from '@bpx-chain/core';
...
export default function PlotQueueLogDialog(props: Props) {
  ...
  return (
    <Dialog maxWidth="md" aria-labelledby="confirmation-dialog-title" onClose={handleClose} open={open}>
